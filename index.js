...
/* Line 11 is a nested function because it is a function created within a function.
...
const zooAnimals = [
 ...
 function lowerCaseNames(zooObj) {
  return zooObj.map((item) => item.animal_name.toLowerCase()); 
}
 ...
 function lowPopulationAnimals(zooObj) {
  return zooObj.filter((item) => item.population < 5);
}
